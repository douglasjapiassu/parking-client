...
export class ExitCalc {
  constructor(
    public lenghtOfStayInMinutes:number,
...
export class HttpClientService {
  ...
  public retrieveExitData(parkingLotId, vehicleId) {
    return this.httpClient.get<ExitCalc>(`${environment.apiUrl}/parking/exit-calc/${parkingLotId}/${vehicleId}`);
  };
